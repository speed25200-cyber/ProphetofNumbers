...
| `WELL19937a` derrière la même carte de rang | même machine | **§255** : les 22 pas `20`–`41` rendent tous un système **incompatible** — sous réserve de la fidélité de ma transcription du générateur, faute de référence sur la machine |
